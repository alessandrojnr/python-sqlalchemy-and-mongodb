...
with Session(engine) as session:
    ...
    alessandro = User(
        name = 'Alessandro',
        fullname = 'Alessandro Junior',
        address= [Address(email_address = 'alessandro123@gmail.com')]
    )

    leticia = User(
        name = "Leticia",
        fullname = "Leticia Andressa",
        address = [Address(email_addres = 'leandressa@yahoo.com')]
    )

    #enviar para db
    session.add_all([nino, nico, jose,alessandro, leticia])
